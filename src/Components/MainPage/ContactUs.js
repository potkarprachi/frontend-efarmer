  ...
  return (
    <>
      <div className="container">
        <div className="row">
          <div className="alert alert-primary text-center pageTitle role" alert>
            <h2>CONTACT US</h2>
            Feel Free To Reach Us For Any Query
          </div>
          <div className="col-7 formholder row">
            ...
            <div className="col-6">
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Main Office: +91-7485961235 <br></br>Toll Free: 1800-000-123
                  </Card.Text>
                  {/* <Button variant="primary">Go somewhere</Button> */}
                </Card.Body>
              </Card>
          ...
          <div className="col-5 formholder">
            <form
