      ...
      <div className="App">
        <BrowserRouter>
          ...
          <Routes>
            ...
            ></Route>
            <Route
              path="/cropStatusFarmer"
              element={<FarmerCropStatus></FarmerCropStatus>}
            ></Route>
            <Route
              path="/farmerdashboard"
              element={<FarDashboard></FarDashboard>}
            ></Route>
            <Route
              path="/farmersidenavbar"
              element={<FarmerSideNav></FarmerSideNav>}
            ></Route>
            ...
            <Route
              path="/adminsidebar"
              element={<AdminSideNav></AdminSideNav>}
            ></Route>
            <Route
              path="/admintransaction"
              element={<AdminTransaction></AdminTransaction>}
            ></Route>
            <Route
              path="/adminCropTable"
              element={<AdminCropStatus></AdminCropStatus>}
            ></Route>
            <Route
              path="/accountupdate"
              element={<AccountUpdateForm></AccountUpdateForm>}
            ></Route>
            <Route
            ...
            <Route
              path="/customerTrans"
              element={<CustomerTransaction></CustomerTransaction>}
            ></Route>
            <Route
              path="/farmerTrans"
              element={<FarmerTransaction></FarmerTransaction>}
            ></Route>
